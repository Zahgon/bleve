...
func (c *collectStoreHeap) Less(i, j int) bool { _ = "STUB: not implemented"; return false }

func (c *collectStoreHeap) Swap(i, j int) { _ = "STUB: not implemented"; return }

func (c *collectStoreHeap) Push(x interface{}) { _ = "STUB: not implemented"; return }

func (c *collectStoreHeap) Pop() interface{} { _ = "STUB: not implemented"; return nil }
