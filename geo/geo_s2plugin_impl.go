...
func (p *Point) IndexCells() ([]uint64, []uint64) { _ = "STUB: not implemented"; return nil, nil }

func (p *Point) QueryCells() ([]uint64, []uint64) { _ = "STUB: not implemented"; return nil, nil }

func (p *Point) BoundingBox() index.GeoJSON { _ = "STUB: not implemented"; return *new(index.GeoJSON) }
